...
│   ├── transform/[id]/page.tsx       # Kết quả: preview + edit + download
│   ├── history/page.tsx
│   └── api/
...
├── components/
├── lib/
│   ├── transformers/docx.ts          # Pipeline Pandoc + assemble
│   ├── transformers/pdf.ts           # Pipeline Ghostscript + AI
...
| `MarkdownPreview` | `/transform/[id]` | Render HTML từ Markdown |
| `MarkdownEditor` | `/transform/[id]` | Textarea sửa Markdown |
